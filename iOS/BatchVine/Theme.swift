...
enum Theme {
    static let accent = Color(hex: "#2F6B3A")
    static let accentSecondary = Color(hex: "#C97B3D")
    static let background = Color(hex: "#F4EFE6")
    static let cardBackground = Color.white.opacity(0.7)
    static let textPrimary = Color(hex: "#2F6B3A").opacity(0.95)
