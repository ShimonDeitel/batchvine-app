...
struct ContentView: View {
    ...
    @State private var editingEntry: WreathEntry?
...
struct AddEntrySheet: View {
    ...
    @State private var draftEmbellishments: String = ""
    ...
    var body: some View {
        NavigationStack {
            Form {
                Section("Wreath Details") {
                    TextField("Name", text: $draftName)
                        .accessibilityIdentifier("field_name")
                    TextField("Base", text: $draftBase)
                .accessibilityIdentifier("field_base")
            TextField("Embellishments", text: $draftEmbellishments)
                .accessibilityIdentifier("field_embellishments")
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        store.add(name: draftName, base: draftBase, embellishments: draftEmbellishments, season: draftSeason, notes: draftNotes)
                        isPresented = false
                    }
        ...
        NavigationStack {
            Form {
                Section("Wreath Details") {
                    ...
                    TextField("Base", text: $entry.base)
                    TextField("Embellishments", text: $entry.embellishments)
